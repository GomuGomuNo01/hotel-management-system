...
<body style="margin:0; padding:0; background-color:#F8FAFC; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color:#2d3748;">
        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%; background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                    ...
                    {{-- Header --}}
                    <tr>
                        <td style="background:linear-gradient(135deg, #1A5333 0%, #247E49 100%); padding:36px 40px; text-align:center;">
                            <h1 style="margin:0; font-size:26px; font-weight:700; color:#ffffff; letter-spacing:-0.5px;">{{ config('app.name') }}</h1>
                            <p style="margin:8px 0 0 0; font-size:13px; color:#BDE6CE; font-weight:500;">{{ config('app.tagline') }}</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:40px 40px 32px 40px;">
                            ...
                            <h2 style="margin:0 0 8px 0; font-size:22px; font-weight:700; color:#1A5333;">Bienvenue, {{ $admin->first_name }} {{ $admin->last_name }} !</h2>
                            ...
                            {{-- Credentials block --}}
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#F4FAF7; border:1px solid #BDE6CE; border-radius:10px; margin-bottom:28px;">
                                <tr>
                                    <td style="padding:24px 28px;">
                                        <p style="margin:0 0 6px 0; font-size:11px; letter-spacing:2px; text-transform:uppercase; color:#247E49; font-weight:700;">Vos identifiants</p>

                                        <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:16px;">
                                            <tr>
                                                <td style="padding:8px 0; border-bottom:1px solid #BDE6CE;">
                                                    <span style="font-size:13px; color:#4a5568; display:block; margin-bottom:2px;">Adresse e-mail</span>
                                                    <span style="font-size:15px; font-weight:600; color:#1A5333;">{{ $admin->email }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:14px 0 8px 0;">
                                                    ...
                                                    <span style="display:inline-block; background-color:#1A5333; color:#ffffff; font-family:'Courier New', Courier, monospace; font-size:16px; font-weight:700; letter-spacing:2px; padding:10px 18px; border-radius:6px;">{{ $temporaryPassword }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td style="padding:20px 28px;">
                                        ...
                                        <p style="margin:0 0 6px 0; font-size:14px; color:#2d3748;">
                                            <strong>Rôle :</strong>
                                            <span style="display:inline-block; background-color:#247E49; color:#ffffff; font-size:12px; font-weight:600; padding:3px 10px; border-radius:20px; margin-left:6px; vertical-align:middle;">{{ $admin->role }}</span>
                                        </p>
                                ...
                                <tr>
                                    <td align="center">
                                        <a href="{{ config('app.frontend_url', '#') }}/login"
                                           style="display:inline-block; background:linear-gradient(135deg, #1A5333 0%, #247E49 100%); color:#ffffff; font-size:15px; font-weight:600; text-decoration:none; padding:14px 36px; border-radius:8px; letter-spacing:0.3px;">
