...
<div class="wrapper">
  ...
  <div class="body">
    ...
    <p>
      Vous avez demandé la réinitialisation du mot de passe de votre compte <strong>{{ config('app.name') }}</strong>.<br>
    ...
    <p>Ce lien est valable <strong>{{ $expire }} minutes</strong>. Passé ce délai, vous devrez en demander un nouveau.</p>
