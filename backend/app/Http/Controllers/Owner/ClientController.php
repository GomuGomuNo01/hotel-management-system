...
class ClientController extends Controller
{
    ...
    /**
     * GET /owner/clients
     * Liste paginée des clients (lecture seule).
     */
     ...
     * Détail d'un client avec ses réservations (lecture seule).
     */
    ...
    /**
     * GET /owner/clients/{id}/id-document?path=...
     * Renvoie une pièce d'identité du client en flux inline (image/PDF) pour
     * consultation dans le lecteur latéral — accès restreint aux documents
