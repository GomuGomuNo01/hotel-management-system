export const STATUS_CONFIG = {
  ...
  checked_in:  { label: 'En séjour',   color: 'bg-blue-50   text-blue-700   border border-blue-200',    dot: 'bg-blue-400'   },
  checked_out: { label: 'Terminée',    color: 'bg-slate-50  text-slate-600  border border-slate-200',   dot: 'bg-slate-400'  },
