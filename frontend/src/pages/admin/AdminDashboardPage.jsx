...
import {
  ...
  Loader2, ArrowRight, RotateCcw, ShieldCheck,
  CalendarCheck, MessageSquareWarning, CheckCircle2, CreditCard,
  Inbox, AlertTriangle, ChevronLeft, ChevronRight,
  ChevronsLeft, ChevronsRight, TrendingUp, Users, BarChart2, Clock,
} from 'lucide-react';
...
function StatCard({ value, label, sublabel, icon: Icon, color = 'slate', to }) {
...
══════════════════════════════════════════════════════════════════ */
function ReservationRow({ reservation: r, actionLabel, btnClass, onAction, loading }) {
