  ...
  return (
    <div className="max-w-md mx-auto px-4 py-12">
      <div className="card card-pad">
        ...
        <p className="text-sm text-gray-500 text-center mt-1">Accédez à votre espace</p>
